...
startScript = raw_input('press any key to start  : ')
os.system("clear")
#Libraries#
try:
    import mechanize,socket,optparse; from os import system as sy; import os
    sy("")
except ImportError:
...
USAGE: python2 ./checkEmail.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------                                                
...
Examples:
        |
     |--------
     | python2 checkEmail.py -s saeedshabt201@gmail.com
     |--------
     | python2 checkEmail.py -m saeedshabt201@gmail.com,saeed201@gmail.com
     |--------
     | python2 checkEmail.py -f emails.txt
     |--------
""")
def Main():
